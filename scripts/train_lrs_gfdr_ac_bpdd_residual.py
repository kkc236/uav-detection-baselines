"""Launch the frozen AC-BPDD-R v1 VisDrone screening arm."""
...
CANDIDATE_CONFIG = ROOT / "configs" / "rtdetr-l-lrs-gfdr-ac-bpdd-residual.yaml"
DEFAULT_RUN_NAME = "formal-seed0-lrs_gfdr_ac_bpdd_residual-v1"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train AC-BPDD-R v1 under the paired Formal100 seed-0 protocol."
    )
...
def build_settings(
    ...
    return {
        **FROZEN_SETTINGS,
        "model": str(CANDIDATE_CONFIG.resolve()),
        "save_period": -1,
...
def build_launch_record(
    *,
    ...
    return {
        "format_version": 1,
        "method_revision": "ac-bpdd-residual-v1",
        "method": "lrs_gfdr_ac_bpdd_residual",
